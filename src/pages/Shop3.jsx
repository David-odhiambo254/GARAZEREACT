...
export default function Shop3(){
  ...
  return (
    <div class="page shop3" dangerouslySetInnerHTML={{__html: `
                        ...
                        <div class="our-shop">
                            <div class="item-shorting">
                                ...
                                <div class="right-column">
                                    ...
                                    <div class="menu-box">
                                        <p>Show:</p>
                                        <button class="grid-view mr_10"><i class="icon-31"></i></button>
                                        <button class="list-view on"><i class="icon-32"></i></button>
                                    </div>
                                </div>
                            </div>
